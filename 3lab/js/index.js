...
function drawCircle(ctx, elements)
{
    ...
    elements.perimeter.innerHTML = "Perimeter of " + elements.shapeSelect.value + ": " +  "<b>" + circle.calculatePerimeter() + "</b>";
}
...
function drawRectangle(ctx, elements)
{
    ...
    elements.perimeter.innerHTML = "Perimeter of " + elements.shapeSelect.value + ": " +  "<b>" + rectangle.calculatePerimeter() + "</b>";
}
...
function drawTriangle(ctx, elements)
{
    ...
    elements.perimeter.innerHTML = "Perimeter of " + elements.shapeSelect.value + ": " +  "<b>" + triangle.calculatePerimeter() + "</b>";
}